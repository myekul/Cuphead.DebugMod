...
public class Settings : PluginComponent {
    ...
    public void Awake() {
        ...
        FlyingBlimpPhaseBlimp2PatternNormal = config.Bind("RNG Hilda Berg", "2nd Blimp Phase Regular", FlyingBlimpPhaseBlimp2PatternsNormal.Random, --order);
        FlyingBlimpPhaseBlimp3PatternNormal = config.Bind("RNG Hilda Berg", "3rd Blimp Phase Regular", FlyingBlimpPhaseBlimp3PatternsNormal.Random, --order);
        FlyingBlimpPhaseBlimp2PatternHard = config.Bind("RNG Hilda Berg", "2nd Blimp Phase Expert", FlyingBlimpPhaseBlimp2PatternsHard.Random, --order);
        FlyingBlimpPhaseBlimp3PatternHard = config.Bind("RNG Hilda Berg", "3rd Blimp Phase Expert", FlyingBlimpPhaseBlimp3PatternsHard.Random, --order);
        FlowerPhaseGeneric1PatternNormal = config.Bind("RNG Cagney Carnation", "Phase 1 Regular", FlowerPhaseGeneric1PatternsNormal.Random, --order);
        FlowerPhaseGeneric2PatternNormal = config.Bind("RNG Cagney Carnation", "Phase 2 Regular", FlowerPhaseGeneric2PatternsNormal.Random, --order);
        FlowerPhaseGeneric3PatternNormal = config.Bind("RNG Cagney Carnation", "Phase 3 Regular", FlowerPhaseGeneric3PatternsNormal.Random, --order);
        FlowerPhaseGenericHeadLungePatternNormal = config.Bind("RNG Cagney Carnation", "Head Lunge Regular", FlowerPhaseGenericHeadLungePatternsNormal.Random, --order);
        ...
        FlyingBirdPhaseOneDirection = config.Bind("RNG Wally Warbles", "Phase 1 Direction", FlyingBirdPhaseOneDirections.Random, --order);
        FlyingBirdPhaseOnePatternEasy = config.Bind("RNG Wally Warbles", "Phase 1 Pattern Simple", FlyingBirdPhaseOnePatternsEasy.Random, --order);
        FlyingBirdPhaseTwoPatternEasy = config.Bind("RNG Wally Warbles", "Phase 2 Pattern Simple", FlyingBirdPhaseTwoPatternsEasy.Random, --order);
        FlyingBirdPhaseOnePatternNormal = config.Bind("RNG Wally Warbles", "Phase 1 Pattern Regular", FlyingBirdPhaseOnePatternsNormal.Random, --order);
        FlyingBirdPhaseTwoPatternNormal = config.Bind("RNG Wally Warbles", "Phase 2 Pattern Regular", FlyingBirdPhaseTwoPatternsNormal.Random, --order);
        FlyingBirdPhaseThreeDirection = config.Bind("RNG Wally Warbles", "Phase 3 Direction", FlyingBirdPhaseThreeDirections.Random, --order);
        FlyingBirdPhaseOnePatternHard = config.Bind("RNG Wally Warbles", "Phase 1 Pattern Expert", FlyingBirdPhaseOnePatternsHard.Random, --order);
        ...
        FlyingGeniePhaseOneTreasurePattern = config.Bind("RNG Djimmi The Great", "Phase 1 Treasure", FlyingGeniePhaseOneTreasurePatterns.Random, --order);
        FlyingGeniePhaseOneSwordTypeEasyNormal = config.Bind("RNG Djimmi The Great", "Phase 1 Sword Parry Pattern Simple/Regular", FlyingGeniePhaseOneSwordTypesEasyNormal.Random, --order);
        FlyingGeniePhaseOneSwordTypeHard = config.Bind("RNG Djimmi The Great", "Phase 1 Sword Parry Pattern Expert", FlyingGeniePhaseOneSwordTypesHard.Random, --order);
        FlyingGeniePhaseOneGemsTypeEasy = config.Bind("RNG Djimmi The Great", "Phase 1 Gems Parry Pattern Simple", FlyingGeniePhaseOneGemsTypesEasy.Random, --order);
        FlyingGeniePhaseOneGemsTypeNormalHard = config.Bind("RNG Djimmi The Great", "Phase 1 Gems Parry Pattern Regular/Expert", FlyingGeniePhaseOneGemsTypesNormalHard.Random, --order);
        FlyingGeniePhaseOneSphinxType = config.Bind("RNG Djimmi The Great", "Phase 1 Sphinx Parry Pattern", FlyingGeniePhaseOneSphinxTypes.Random, --order);
        FlyingGeniePhaseTwoObeliskPattern = config.Bind("RNG Djimmi The Great", "Phase 2 Face Positions", FlyingGeniePhaseTwoObeliskPatterns.Random, --order);
        ...
        DragonPhaseTwoPatternEasy = config.Bind("RNG Grim Matchstick", "Phase 2 Pattern Simple", DragonPhaseTwoPatternsEasy.Random, --order);
        DragonPhaseThreePatternNormal = config.Bind("RNG Grim Matchstick", "Phase 3 Pattern Regular", DragonPhaseThreePatternsNormal.Random, --order);
        DragonPhaseOnePatternHard = config.Bind("RNG Grim Matchstick", "Phase 1 Pattern Expert", DragonPhaseOnePatternsHard.Random, --order);
        DragonPhaseTwoPatternHard = config.Bind("RNG Grim Matchstick", "Phase 2 Pattern Expert", DragonPhaseTwoPatternsHard.Random, --order);
        DragonPhaseOneLaserPatternEasy = config.Bind("RNG Grim Matchstick", "Phase 1 Laser Pattern Simple", DragonPhaseOneLaserPatternsEasy.Random, --order);
        DragonPhaseTwoLaserPatternEasy = config.Bind("RNG Grim Matchstick", "Phase 2 Laser Pattern Simple", DragonPhaseTwoLaserPatternsEasy.Random, --order);
        DragonPhaseOneMeteorPatternEasy = config.Bind("RNG Grim Matchstick", "Phase 1 Meteor Pattern Simple", DragonPhaseOneMeteorPatternsEasy.Random, --order);
        DragonPhaseTwoMeteorPatternEasy = config.Bind("RNG Grim Matchstick", "Phase 2 Meteor Pattern Simple", DragonPhaseTwoMeteorPatternsEasy.Random, --order);
        DragonPhaseOneLaserPatternNormal = config.Bind("RNG Grim Matchstick", "Phase 1 Laser Pattern Regular", DragonPhaseOneLaserPatternsNormal.Random, --order);
        DragonPhaseThreeLaserPatternNormal = config.Bind("RNG Grim Matchstick", "Phase 3 Laser Pattern Regular", DragonPhaseThreeLaserPatternsNormal.Random, --order);
        DragonPhaseTwoMeteorPatternNormal = config.Bind("RNG Grim Matchstick", "Phase 2 Meteor Pattern Regular", DragonPhaseTwoMeteorPatternsNormal.Random, --order);
        DragonPhaseThreeMeteorPatternNormal = config.Bind("RNG Grim Matchstick", "Phase 3 Meteor Pattern Regular", DragonPhaseThreeMeteorPatternsNormal.Random, --order);
        DragonPhaseOneMeteorPatternHard = config.Bind("RNG Grim Matchstick", "Phase 1 Meteor Pattern Expert", DragonPhaseOneMeteorPatternsHard.Random, --order);
        DragonPhaseTwoMeteorPatternHard = config.Bind("RNG Grim Matchstick", "Phase 2 Meteor Pattern Expert", DragonPhaseTwoMeteorPatternsHard.Random, --order);
        DragonPhaseOneLaserPatternHard = config.Bind("RNG Grim Matchstick", "Phase 1 Laser Pattern Expert", DragonPhaseOneLaserPatternsHard.Random, --order);
        DragonPhaseTwoLaserPatternHard = config.Bind("RNG Grim Matchstick", "Phase 2 Laser Pattern Expert", DragonPhaseTwoLaserPatternsHard.Random, --order);
        BeePhaseTwoPatternEasy = config.Bind("RNG Rumor Honeybottoms", "Phase 2 Simple", BeePhaseTwoPatternsEasy.Random, --order);
        BeePhaseTwoPatternNormal = config.Bind("RNG Rumor Honeybottoms", "Phase 2 Regular", BeePhaseTwoPatternsNormal.Random, --order);
        ...
        SallyStageplayPatternNormalHard = config.Bind("RNG Sally Stageplay", "Phase 1 Regular/Expert", SallyStageplayPatternsNormalHard.Random, --order);
        SallyStageplayJumpCountEasy = config.Bind("RNG Sally Stageplay", "Phase 1 Jump Count Simple", SallyStageplayJumpCountsEasy.Random, --order);
        SallyStageplayJumpCountNormalHard = config.Bind("RNG Sally Stageplay", "Phase 1 Jump Count Regular/Expert", SallyStageplayJumpCountsNormalHard.Random, --order);
        SallyStageplayJumpTypeEasy = config.Bind("RNG Sally Stageplay", "Phase 1 Jump Type Simple", SallyStageplayJumpTypesEasy.Random, --order);
        SallyStageplayJumpTypeNormalHard = config.Bind("RNG Sally Stageplay", "Phase 1 Jump Type Regular/Expert", SallyStageplayJumpTypesNormalHard.Random, --order);
        SallyStageplayTeleportOffsetEasy = config.Bind("RNG Sally Stageplay", "Phase 1 Teleport Offset Simple", SallyStageplayTeleportOffsetsEasy.Random, --order);
        SallyStageplayTeleportOffsetNormalHard = config.Bind("RNG Sally Stageplay", "Phase 1 Teleport Offset Regular/Expert", SallyStageplayTeleportOffsetsNormalHard.Random, --order);
        ...
        PiratePhaseOneGunPatternNormal = config.Bind("RNG Captain Brineybeard", "Phase 1 Gun Regular", PiratePhaseOneGunPatternsNormal.Random, --order);
        PiratePhaseTwoGunPatternNormal = config.Bind("RNG Captain Brineybeard", "Phase 2 Gun Regular", PiratePhaseTwoGunPatternsNormal.Random, --order);
        PiratePhaseThreeGunPatternNormal = config.Bind("RNG Captain Brineybeard", "Phase 3 Gun Regular", PiratePhaseThreeGunPatternsNormal.Random, --order);
        PiratePhaseOneGunPatternHard = config.Bind("RNG Captain Brineybeard", "Phase 1 Gun Expert", PiratePhaseOneGunPatternsHard.Random, --order);
        PiratePhaseTwoGunPatternHard = config.Bind("RNG Captain Brineybeard", "Phase 2 Gun Expert", PiratePhaseTwoGunPatternsHard.Random, --order);
        PiratePhaseThreeGunPatternHard = config.Bind("RNG Captain Brineybeard", "Phase 3 Gun Expert", PiratePhaseThreeGunPatternsHard.Random, --order);
        PiratePhaseFourPatternEasy = config.Bind("RNG Captain Brineybeard", "Phase 4 Simple", PiratePhaseFourPatternsEasy.Random, --order);
        ...
        FlyingMermaidPhaseOneFishPattern = config.Bind("RNG Cala Maria", "Phase 1 Fish", FlyingMermaidPhaseOneFishPatterns.Random, --order);
        FlyingMermaidPhaseOneSummonPattern = config.Bind("RNG Cala Maria", "Phase 1 Summon", FlyingMermaidPhaseOneSummonPatterns.Random, --order);
        ...
        DevilClapDelay = config.Bind("RNG The Devil", "Phase 1 Clap Delay (0.1-0.5, -1 for random)", -1f, --order);
        DevilPhaseOnePattern = config.Bind("RNG The Devil", "Phase 1 Pattern", DevilPhaseOnePatterns.Random, --order);
        DevilPhaseOneHeadType = config.Bind("RNG The Devil", "Phase 1 Head Type", DevilPhaseOneHeadTypes.Random, --order);
        DevilPhaseOneDragonDirection = config.Bind("RNG The Devil", "Phase 1 Dragon Direction", DevilPhaseOneDragonDirections.Random, --order);
        DevilPhaseOneSpiderOffset = config.Bind("RNG The Devil", "Phase 1 Spider Offset", DevilPhaseOneSpiderOffsets.Random, --order);
